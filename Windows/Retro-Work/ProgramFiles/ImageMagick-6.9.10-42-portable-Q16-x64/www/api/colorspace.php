...
<p>GetImageColorspaceType() returns the potential colorspace of image: sRGBColorspaceType, RGBColorspaceType, GRAYColorspaceType, etc.</p>
...
<dd>  </dd>
  ...
  <footer class="magick-footer">
    ...
    &nbsp; &nbsp;
    <a href="colorspace.php#"><img class="d-inline" id="wand" alt="And Now a Touch of Magick" width="16" height="16" src="../image/wand.ico"/></a>
    &nbsp; &nbsp;
