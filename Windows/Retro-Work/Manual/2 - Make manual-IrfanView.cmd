...
REM Creates a pdf file from multiple tif files
REM Requires irfanview and pdftoolkit (server version)

set irfanpath="c:\Program Files (x86)\IrfanView\i_view32.exe"
...
"%irfanpath%" .\*.tif /convert=.\output\*.pdf
